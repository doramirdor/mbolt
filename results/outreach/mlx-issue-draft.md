...
- Anti-result worth knowing: mmap/page-fault streaming is layout-blind (identical tok/s and pageins regardless of layout). If your streamer reads *slices* explicitly — which the PoCs cited in these threads do — you get the layout win; if it demand-pages, you don't.
