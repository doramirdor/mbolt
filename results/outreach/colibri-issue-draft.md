...
Everything (I/O simulator, gate methodology, cold-cache discipline for macOS, negative results incl. why speculative prefetch didn't pay for 512-expert routing) is in the repo: <REPO LINK>. Happy to run the pipeline on a GLM-5.2 trace if you can point me at a routing log format, or to add a layout pass to your converter behind a flag.
